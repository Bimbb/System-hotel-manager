...
public class pn_LoaiDichVu extends javax.swing.JPanel {

    public pn_LoaiDichVu() {
        initComponents();
        load();
    }
    ...
    private void initComponents() {
        ...
        lbTenTrang.setText("Loại dịch vụ");
        ...
        jScrollPane2.setViewportView(tbLoaiDichVu);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        fr_LoaiDichVu form = new fr_LoaiDichVu(this);
        fr_LoaiDichVu.IdloaiDichVu = -1;
    ...
    private void tbLoaiDichVuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLoaiDichVuMouseClicked
        ...
        if(evt.getClickCount() == 2){
            fr_LoaiDichVu.IdloaiDichVu = Integer.parseInt(tbLoaiDichVu.getModel().getValueAt(tbLoaiDichVu.getSelectedRow(), 0).toString());
            fr_LoaiDichVu form = new fr_LoaiDichVu(this);
            form.setVisible(true);
        }
    ...
    public void load(){
        ArrayList<LoaiDichVu> DSLoaiDichVu = new LoaiDichVuController().layDSLoaiDV();
        DefaultTableModel model = (DefaultTableModel) tbLoaiDichVu.getModel();
        model.setRowCount(0);
        for(LoaiDichVu lp : DSLoaiDichVu){
            Object[] objmodel = new Object[]{lp.getIDLOAIDICHVU(),lp.getTENLOAIDICHVU()};
            model.addRow(objmodel);
        }
    }
    
    public void loadTimKiem(String TenLP){
        ArrayList<LoaiDichVu> DSLoaiDichVu = new LoaiDichVuController().layDSLoaiDVTheoTen(TenLP);
        DefaultTableModel model = (DefaultTableModel) tbLoaiDichVu.getModel();
        model.setRowCount(0);
        for(LoaiDichVu lp : DSLoaiDichVu){
            Object[] objmodel = new Object[]{lp.getIDLOAIDICHVU(),lp.getTENLOAIDICHVU()};
