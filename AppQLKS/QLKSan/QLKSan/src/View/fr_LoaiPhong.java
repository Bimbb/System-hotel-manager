...
public class fr_LoaiPhong extends javax.swing.JFrame {

    public static int IdloaiPhong;
    pn_LoaiPhong form = new pn_LoaiPhong();
    ...
    public fr_LoaiPhong(pn_LoaiPhong pnLoaiPhong){
        initComponents();
        form = pnLoaiPhong;
        this.setLocationRelativeTo(null);
        hienthongtin();
    ...
    private void btSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaveActionPerformed
        if(kiemtrathongtin()){
            if(!LoaiPhongController.kiemtraDB(IdloaiPhong)){
                
                if(!LoaiPhongController.kiemtraTen(txtLoaiPhong.getText())){
                    boolean x = LoaiPhongController.Them(txtLoaiPhong.getText());
                    if(x == false){
                ...
                if(!LoaiPhongController.kiemtraTenTruDoiTuongDuocTron(IdloaiPhong,txtLoaiPhong.getText())){
                    boolean x = LoaiPhongController.Sua(IdloaiPhong,txtLoaiPhong.getText());
                    if(x == false){
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        if(kq == JOptionPane.YES_OPTION){
            boolean x = LoaiPhongController.Xoa(IdloaiPhong);
            if(x == true){
...
//                JOptionPane.showMessageDialog(this, "Lỗi khi xóa");
    ...
    private void hienthongtin(){
        String value = LoaiPhongController.LayTenLoaiPhong(IdloaiPhong);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fr_LoaiPhong().setVisible(true);
            }
        });
    }
