...
public class pn_DichVu extends javax.swing.JPanel {
    public pn_DichVu() {
        initComponents();
        load();
    }
    ...
    private void initComponents() {
        ...
        tbDichVu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Dịch vụ", "Đơn giá", "DVT", "Loại dịch vụ"
            }
        ));
    ...
    public void load(){
        String ldv = "";
        ArrayList<DichVu> DSDichVu = new DichVuController().layDSDichVu();
        DefaultTableModel model = (DefaultTableModel) tbDichVu.getModel();
        model.setRowCount(0);
        for(DichVu lp : DSDichVu){
            ldv = DichVuController.LayTenLoaiDichVu(lp.getIDLOAIDICHVU());
            Object[] objmodel = new Object[]{lp.getIDDICHVU(),lp.getTENDICHVU(),lp.getDONGIABAN(),lp.getDVT(),ldv};
    ...
    public void loadTimKiem(String TenLP){
        String ldv = "";
        ArrayList<DichVu> DSDichVu = new DichVuController().layDSDichVuTheoTen(TenLP);
        DefaultTableModel model = (DefaultTableModel) tbDichVu.getModel();
        model.setRowCount(0);
        for(DichVu lp : DSDichVu){
            ldv = DichVuController.LayTenLoaiDichVu(lp.getIDLOAIDICHVU());
